...
public class CalculateElectricityBillTest {
    ...
    @Test
    void testCase07() {
        double actual = calculateElectricityBill.calculateElectricityBill(500, 0.16, "sinh_hoat");
        assertEquals(-1.0, actual);
    }

    @Test
    void testCase08() {
        double actual = calculateElectricityBill.calculateElectricityBill(0, 0.08, "sinh_hoat");
        assertEquals(-1.0, actual);
    }
    ...
    @Test
    void testCase13() {
        double actual = calculateElectricityBill.calculateElectricityBill(1001, 0.08, "sinh_hoat");
        assertEquals(-1.0, actual);
    }
    ...
    @Test
    void testCase15() {
        double actual = calculateElectricityBill.calculateElectricityBill(1, 0.0, "sinh_hoat");
        assertEquals(1.68, actual, 0);
    }
    ...
    @Test
    void testCase17() {
        double actual = calculateElectricityBill.calculateElectricityBill(0, 0.05, "kinh_doanh");
        assertEquals(-1.0, actual);
    }

    @Test
    void testCase18() {
        double actual = calculateElectricityBill.calculateElectricityBill(222, -0.1, "kinh_doanh");
        assertEquals(-1.0, actual);
    }
